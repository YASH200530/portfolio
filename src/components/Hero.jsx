...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const animate = (currentTime) => {
      ...
      // FPS throttling
      if (
        currentTime - lastFrameTime.current <
        1000 / performanceConfig.targetFPS
      ) {
        animationRef.current = requestAnimationFrame(animate);
        return;
      }
  ...
  return (
    <section
      className="relative py-20 md:py-32 min-h-screen flex items-center justify-center bg-black overflow-hidden"
      data-hero-section
    >
      <canvas
        ref={canvasRef}
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-xl leading-relaxed max-w-3xl mx-auto text-muted-foreground floating-text opacity-90">
              Where complexity meets clarity: I ask the right questions and
              engineer innovative solutions that actually work
            </p>
          </div>
        </div>
      </div>
